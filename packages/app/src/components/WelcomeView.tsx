        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 shadow-xl animate-in fade-in zoom-in-95 duration-500">
          <div className="mb-6 md:mb-8 text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mb-1.5 tracking-tight">
              {step === 1 ? 'Secure Your Vault' : 'Quick Access'}
            </h1>
            <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400 font-medium">
              {step === 1
                ? 'Create a master key to encrypt your data locally.'
                : 'Speed up your login experience securely.'}
            </p>
          </div>
          ...
          {step === 1 && (
            <div className="space-y-4 md:space-y-6">
              <div className="space-y-1.5">
                <label className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Master Key</label>
              ...
              <div className="space-y-1.5">
                <label className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Verify Key</label>
                <div className="relative group">
            ...
            <div className="space-y-4 md:space-y-6 py-1">
              ...
              >
                ...
                <div className="flex-1">
                  <h4 className={`font-bold text-base md:text-lg transition-colors ${bioEnabled ? 'text-slate-900 dark:text-white' : 'text-slate-400'}`}>Biometric Lock</h4>
                  <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium italic">Face ID / Touch ID</p>
                </div>
