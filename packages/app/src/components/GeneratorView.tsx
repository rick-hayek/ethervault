        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="bg-white dark:bg-slate-900 p-6 md:p-10 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden flex-1 flex flex-col justify-center min-h-[300px]">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-sky-500 rounded-[32px] blur-2xl opacity-5 dark:opacity-10 pointer-events-none" />

              <div className="relative text-center space-y-8 z-10">
                <span className="text-3xl md:text-5xl font-mono font-bold text-slate-800 dark:text-white line-clamp-2 break-all w-full px-4 tracking-tight leading-tight selection:bg-indigo-500 selection:text-white min-h-[1.2em]">
                  {password}
                </span>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-sm h-full flex flex-col justify-center">
              <div className="space-y-8">
                <div>
                  ...
                  <div className="h-10 flex items-center px-1">
                    <input
                      ...
                      className="w-full h-3 bg-slate-100 dark:bg-slate-800 rounded-full appearance-none cursor-pointer accent-indigo-600 hover:accent-indigo-500 transition-all touch-none"
                    />
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex items-start gap-3">
                  <div className="p-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-full text-indigo-500 shrink-0">
