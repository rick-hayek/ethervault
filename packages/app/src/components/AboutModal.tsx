                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 truncate">github.com/rick-hayek/ethervault</div>
                                </div>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 truncate">{t('about.contact', 'Contact Us')}</div>
                                </div>
                                <ExternalLink size={14} className="text-slate-400 group-hover:text-indigo-500 transition-colors" />
                            </button>
                        </div>
